...
export default async function GardenAccessoriesPage({
    searchParams,
}: {
    ...
    // Filter by garden-accessories category
    let filteredProducts = allProducts.filter(p => p.categories?.includes('garden-accessories'));
