...
import gardeningHero from '@/images/gardening/herosection.webp';
    ...
    return (
        <section ref={containerRef} className="relative w-full h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden text-white">
            <div ref={imageRef} className="absolute inset-0 w-full h-full z-0">
                <Image
                    src={gardeningHero}
                    alt="Garden Accessories Background"
                    fill
            ...
            <div className="relative z-10 text-center px-4 max-w-4xl mx-auto text-white">
                ...
                <p ref={textRef} className="text-xl md:text-2xl font-light max-w-2xl mx-auto drop-shadow-md text-gray-100/90 leading-relaxed">
                    Small things that make a big difference in your green space.
                </p>
            </div>
        </section>
    );
